<div class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li
                class="nav-item {{ request()->is('dataset-admin-super') || request()->is('dataset-admin-super/create') || request()->is('dataset-admin-super/details/*') || request()->is('dataset-admin-super/edit/*') || request()->is('dataset-admin-super/cari-tahun/*') ? 'active' : '' }}">
            ...
            <li
                class="nav-item {{ request()->is('laporan-admin-super') || request()->is('laporan-admin-super/*') ? 'active' : '' }}">
