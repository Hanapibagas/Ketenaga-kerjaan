            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-style mb-30">
                        ...
                        <form action="{{ route('get.UpdateLppd', $lppd->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" value="{{ $lppd->nama_lppd }}" name="nama_lppd"
                                            placeholder="Nama LPPD" />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="input-style-1">
                                        <label>Target LPPD <i class="text-danger" style="font-size: 10px;">(Perhatikan
                                                target lppd ini)</i></label>
                                ...
                                <div class="col-12">
                                    <div class="input-style-1">
                                        ...
                                        <select name="tahun" class="form-control">
                                            <option value="{{ $lppd->tahun }}">Tahun saat ini {{ $lppd->tahun }}
                                            </option>
