            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="title mb-30">
                        <h2>Data Setting Profile Dinas</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card-style mb-30">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="title mb-30">
                                    <h6 class="mb-10">Setting Profile Dinas Data Table</h6>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="exampleModal-{{ $data->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('get.UpdateProfile', $data->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
