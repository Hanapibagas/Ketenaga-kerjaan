            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="title mb-30">
                        <h2>Data Setting Prakata Kepala Dinas</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card-style mb-30">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="title mb-30">
                                    <h6 class="mb-10">Setting Prakata Kepala Dinas Data Table</h6>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="table" class="table">
                                <thead>
                                    <tr>
                                        <th>Prakata Kepala Dinas</th>
                                        <th>Nama Kepala Dinas</th>
                                        <th>Jabatan Kepala Dinas</th>
                                        <th>Foto Kepala Dinas</th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ( $prakata as $data )
                                    <tr>
                                        <td>{{ Str::limit($data->text, 100) }}</td>
                                        <td>{{ $data->nama }}</td>
                                        <td>{{ $data->jabatan }}</td>
                                        <td>
...
<div class="modal fade" id="exampleModal-{{ $data->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('get.UpdatePrakata', $data->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input type="text" value="{{ $data->nama }}" id="nama"
                                class="@error('nama') is-invalid @enderror" name="nama" />
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="input-style-1">
                            <label for="jabatan">Jabatan kepala dinas</label>
                            <input type="text" value="{{ $data->jabatan }}" id="jabatan"
                                class="@error('jabatan') is-invalid @enderror" name="jabatan" />
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="input-style-1">
                            <label for="logo">Prakata kepala dinas</label>
                            <textarea name="text" id="" cols="30" rows="10">{{ $data->text }}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="input-style-1">
                            <label for="logo">Foto kepala dinas</label>
